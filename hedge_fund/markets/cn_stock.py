...
class CNStockAdapter(MarketAdapter):
    ...
    def __init__(self, validator: Optional[DataValidator] = None):
        ...
        # from hedge_fund.markets.sources.yfinance_source import YFinanceSource  # Disabled: Not available in China
        from hedge_fund.markets.sources.tushare_source import TushareSource
